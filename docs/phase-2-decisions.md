...
- 결정 일자: 2026-05-21
- 결과:
  - GitHub repo: <https://github.com/hotsybk/bridge> (Public)
  - Vercel CLI 셋업 완료 (`vercel link` + `vercel env add` × 12)
  - Production URL: <https://bridge-nine-green.vercel.app>
  - Production (hash) URL: <https://bridge-3xpivl8h2-hotsybks-projects.vercel.app>
  - Firebase Auth Authorized Domains 등록 완료
  - 시드 계정 (`buyer@`, `vendor@`, `admin@example.com`) production 로그인 검증 통과
- 비고: 환경변수는 Vercel CLI 로 Production 환경에만 등록. Preview/Development 는 Phase 2 staging 생성 시 별도 추가 예정.
...
| # | 결정 항목 | 권장 | 사용자 선택 | 결정일 |
|---|---|---|---|---|
| 1 | Vercel Preview 시작 시점 | A (즉시) | **A** ☑ | 2026-05-21 |
