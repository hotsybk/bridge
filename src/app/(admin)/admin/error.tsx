...
// Phase ν-1 — admin route group error boundary.
// AdminSidebar + AdminTopBar 는 상위 layout 에서 그대로 보존됨 — 본 컴포넌트는 main 영역에 렌더.
    ...
    <div className="px-8 py-16 md:px-12 md:py-24">
      <div className="mx-auto max-w-md text-center">
        ...
        <p className="mt-4 text-sm leading-relaxed text-[var(--color-text-secondary)]">
          요청을 처리하는 중 오류가 발생했습니다. 다시 시도하거나 운영자 홈으로 돌아가 주세요.
        </p>
        {error.digest && (
